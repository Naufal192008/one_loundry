...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="/modules/chatbot/" class="nav-item <?= strpos($uri,'/chatbot')!==false?'active':'' ?>"><span class="nav-icon">🤖</span><span>AI Chatbot</span></a>
        <a href="/modules/analytics/" class="nav-item <?= strpos($uri,'/analytics')!==false?'active':'' ?>"><span class="nav-icon">📈</span><span>Analitik</span></a>
    ...
    <div class="sidebar-footer">
        <a href="/modules/auth/logout.php" style="display:flex;align-items:center;gap:8px;padding:10px 16px;background:var(--gray-100);border-radius:var(--radius-sm);text-decoration:none;color:var(--gray-700);font-weight:500;width:100%;"><span>🚪</span><span>Keluar</span></a>
    </div>
</aside>